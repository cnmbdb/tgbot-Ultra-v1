        ...
        <div class="col-lg-12">
            <div class="wrapper wrapper-content animated fadeInUp">
                ...
                1. 收款钱包，不能和闪兑钱包用同一个。<b style="color:blue">一定要注意开始拉取交易时间</b><p>
                    ...
                    5. 笔数套餐：只有自己质押代理的时候，才能代理 笔数代理期限30天；第三方平台按各自规则执行（NL-API固定按1小时1笔）<p>
                    ...
                    8. 笔数套餐：笔数代理方式 设置为 提交到NL-API 时，需在 能量平台 模块添加第7个平台(NL-API)，并配置 API 用户名/API密码（备注可选配置 nl_api_url=... 覆盖默认域名）<p>
                    9. 当该地址是代理用户ID时，代理用户一定要关注对应的机器人，并充值trx余额。不要给代理机器人管理员预支权限，这部分无法扣款！<p>
                    10. 滞留暂停天数：当笔数超过这么多天都未使用时，自动暂停，0表示无限制
                </div>
