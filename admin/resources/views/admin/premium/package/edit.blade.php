...
@section('contents')
    <div class="widget-body">
        <div class="widget-main" style="padding:0;">
            ...
            @endsection
            <div class="form-box">
                <form class="layui-form" action="{{route('admin.premium.package.update')}}" id="add_news" name="add_news"  method="POST">
                    <div class="layui-form-item" style="margin-top:10px">
                        <label class="layui-form-label">会员平台ID：</label>
                        <div class="layui-col-md5"  style="margin-top:10px">
                            <span >{{$data->premium_platform_rid}}</span>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">套餐月份：</label>
                        <div class="layui-col-md5">
                            <select name="package_month" lay-filter="package_month"  id="package_month" lay-verify="required">
                                @foreach ($PackageMonth as $k => $val)
                                    <option value="{{$k}}" @if ($data->package_month == $k) selected @endif>{{$val}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                            <label class="layui-form-label">USDT售价：</label>
                            <div class="layui-col-md5">
                                <input type="text" name="usdt_price"  autocomplete="off" class="layui-input" value="{{$data->usdt_price}}">
                            </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block layui-input-block-fine-tuning">
                            ...
                            <input type="hidden" name="premium_platform_rid" value="{{$data->premium_platform_rid}}">
                ...
                $("#add_news").ajaxSubmit({
                    ...
                    'success':function(res){
                        ...
                        if (res.code == 200) {
                            ...
                            setTimeout(() => {
                                location.href= '{{route("admin.premium.package.index")}}';
                            }, 1000);
                            return false;
                        } else {
